...
import xlong.converter.SampleToWekaInstanceConverter;
...
//		flatComposite.save("result/flat");
		...
		SampleToWekaInstanceConverter converter2 = new SampleToWekaInstanceConverter(converter.getDictionary().size());
		for (Sample sample:flatComposite.getInstances()) {
			converter2.addSample(sample, Labels.getLabel(10));
		}
